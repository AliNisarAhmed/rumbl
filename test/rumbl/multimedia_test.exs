defmodule Rumbl.MultimediaTest do
  ...
  describe "categories" do
    ...
    test "list_alphabetical_categories/0" do
      ...
      assert alpha_names == Enum.sort(cats)
    end
  ...
  describe "videos" do
    ...
    test "get_video/2 with invalid data returns error changeset" do
      owner = user_fixture()
    ...
    test "udpate_video/2 with invalid data returns an error changeset" do
      owner = user_fixture()
